...
public partial class SistemaInventarioVentasContext : DbContext
{
    ...
    => optionsBuilder.UseSqlServer("Server=YEHUDY;Database=SistemaInventarioVentas;Integrated Security=True;Trusted_Connection=True;TrustServerCertificate=True;");
